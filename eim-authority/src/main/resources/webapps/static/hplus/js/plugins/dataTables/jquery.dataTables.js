...
(/** @lends <global> */function( $ ) {
	...
	DataTable = function( options )
	{
		 ...
		 * previous, first or last webapps.
	 ...
	 *  * `webapps` - Total number of webapps
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 * * `\_PAGES\_` - Total number of webapps of data in the table
			 *
			 *  @type string
	...
	DataTable.ext = _ext = {
		 ...
		 * 2. `{int} webapps` The number of webapps in the table
		 *
		 ...
		 *    $.fn.dataTableExt.oPagination.current = function ( page, webapps ) {
